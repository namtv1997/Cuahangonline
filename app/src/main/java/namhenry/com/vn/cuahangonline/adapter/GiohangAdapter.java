...
import namhenry.com.vn.cuahangonline.activity.GiohangActivity;
import namhenry.com.vn.cuahangonline.activity.MainActivity;
...
public class GiohangAdapter extends BaseAdapter {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        Picasso.with(context).load(giohang.getHinhsp()).placeholder(R.drawable.noimage)
